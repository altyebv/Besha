...
//    // ==================== Exam Queries ====================
//
//    fun getAllExams(): Flow<List<Exam>> = quizBankRepository.getAllExams()
//
//    fun getExamsBySubject(subjectId: String): Flow<List<Exam>> =
//        quizBankRepository.getExamsBySubject(subjectId)
//
//    fun getExamsBySource(source: ExamSource): Flow<List<Exam>> =
//        quizBankRepository.getExamsBySource.(source)
//
//    suspend fun getExamById(examId: String): Exam? =
//        quizBankRepository.getExamById(examId)
//
//    suspend fun getQuestionsForExam(examId: String): List<Question> =
//        quizBankRepository.getQuestionsForExam(examId)
//
//    fun getQuestionsForExamFlow(examId: String): Flow<List<Question>> =
//        quizBankRepository.getQuestionsForExamFlow(examId)
//
//    // ==================== Question Queries ====================
//
...
//        quizBankRepository.getQuestionsBySubject(subjectId)
//
//    fun getQuestionsByUnit(unitId: String): Flow<List<Question>> =
//        quizBankRepository.getQuestionsByUnit(unitId)
//
//    fun getQuestionsByType(subjectId: String, type: QuestionType): Flow<List<Question>> =
//        quizBankRepository.getQuestionsByType(subjectId, type)
//
//    fun getFeedEligibleQuestions(subjectId: String): Flow<List<Question>> =
//        quizBankRepository.getFeedEligibleQuestions(subjectId)
//
//    /**
...
//        val notRecentlyShown = quizBankRepository.getQuestionsNotRecentlyShown(threshold)
//            .map { it.questionId }
//            .toSet()
//
...
//        var questions = quizBankRepository.getQuestionsByUnitIds(subjectId, targetUnitIds).first()
//
//        // Apply filters
