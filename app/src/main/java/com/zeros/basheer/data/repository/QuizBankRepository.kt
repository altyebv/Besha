...
import com.zeros.basheer.data.local.dao.LessonDao
import com.zeros.basheer.data.local.dao.PracticeSessionDao
import com.zeros.basheer.data.local.dao.ProgressDao
...
class QuizBankRepository @Inject constructor(
    ...
    suspend fun getQuestionsByProgress(
        ...
        val completedLessons = progressDao.getCompletedLessons().first()
        ...
        val recentLessons = progressDao.getRecentlyAccessedLessons(5).first()
